...
/**
 * Instrumented tests for the [MainScreenV2] composable.
 *
 * We use test doubles for the [StopWatch] class, so that we can verify that the
 * [MainScreenV2] composable calls the appropriate methods when the buttons are clicked.
 *
